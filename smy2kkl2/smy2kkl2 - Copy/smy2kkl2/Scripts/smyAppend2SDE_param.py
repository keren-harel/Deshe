...
if __name__=='__main__':
    ...
    try:
        ...
        if not for_no.isdigit():
            print(f'{for_no} is not forest number.')
            sys.exit()
        ...
        for l in [sdeSamples, sdeStands]:
            ...
            if not arcpy.Exists(l):
                arcpy.AddWarning(f'SDE layer {l} does not exist')
                sys.exit()
        ...
        for gdbObjectName in gdb_sde_dic:
            ...
            if arcpy.Exists(sdeObject):
                ...
                arcpy.AddWarning(f'The SDE object {sdeObject} does not exists.')
                sys.exit()
